...
public class TransferProposalManager {
    ...
    ledger
      ...
      .reduce((LedgerOffset) LedgerOffset.LedgerBegin.getInstance(), (offset, acs) -> {
        acs
          ...
          .flatMap(com.rln.gui.backend.ods.TransferProposal::createFrom)
  ...
  private static LedgerOffset getLedgerOffset(GetActiveContractsResponse acs, LedgerOffset defaultOffset) {
